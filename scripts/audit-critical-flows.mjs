...
expect("src/routes/_authenticated/buscar.tsx", ["createListingDraft", "verified_item", "Comparar no ML", "normalizeSearchTerm", "Vendas só aparecem", "Ver anúncio", "Duplicar anúncio", "Duplicação criada no painel", 'to: "/editor/$id"'], "busca/cópia mostra métricas verificadas, ações claras e confirmação real da duplicação");
