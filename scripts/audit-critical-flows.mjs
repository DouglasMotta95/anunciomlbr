...
expect("src/lib/ml-public-search.functions.ts", ["official-api-first-public-page-only-on-zero", "discoverPublicAds", "context.userId", "if (byId.size === 0)", "searchMercadoLivrePublicSiteFallback", "searchAdsWithGeminiGrounding"], "endpoint comum usa API oficial antes do fallback público e só depois usa redundâncias web");
