...
expect("src/lib/ml-public-search.functions.ts", ["official-api-first-public-page-only-on-zero", "discoverPublicAds", "context.userId", "if (byId.size === 0)", "searchMercadoLivrePublicSiteFallback", "firecrawlSearchMercadoLivre", "firecrawlConfigured", "searchAdsWithGeminiGrounding"], "endpoint comum usa API oficial, fallback público e Firecrawl como primeira redundância web antes do grounding");
expectNot("src/lib/ml-public-search.functions.ts", ["marketplace-keyword-multi-offer"], "auditoria não depende do contrato antigo de busca");
