...
expect("src/lib/ml-public-site-fallback.server.ts", ["https://lista.mercadolivre.com.br/", "normalizeSearchTerm(query).toLowerCase()", "itemIdFromRealMlUrl", "extractPriceCents", "extractSeller", 'source_kind: catalog ? "catalog_offer" : "marketplace"'], "fallback público extrai dados somente de anúncios com URL real do Mercado Livre");
